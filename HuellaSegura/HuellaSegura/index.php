    ...
    <main class="main-content">
        ...
        <section class="mascotas-perdidas">
            ...
            <div class="perdidas-help">
                ...
                <!-- Mis mascotas -->
        <section class="seccion-mis-mascotas" style="display: none;">
            <div class="section-header">
                <h2>Mis Mascotas</h2>
                <button class="btn-add" onclick="window.location.href='mis-mascotas.php'">+ Agregar</button>
            </div>
            ...
            <div class="mascotas-grid">
                    ...
                    <?php while($mascota = $resultado_mascotas->fetch_assoc()): ?>
                        <div class="mascota-card" onclick="window.location.href='perfil-mascota.php?id=<?php echo $mascota['id_mascota']; ?>'">
                            <img src="imagenes/<?php echo !empty($mascota['foto_mascota']) ? $mascota['foto_mascota'] : 'mascota-default.jpg'; ?>" 
                                 alt="<?php echo $mascota['nombre_mascota']; ?>" class="mascota-photo">
                            <div class="mascota-info">
                                <h3><?php echo $mascota['nombre_mascota']; ?></h3>
                                <p><?php echo ucfirst($mascota['tipo']); ?> • <?php echo $mascota['raza'] ?? 'Mestizo'; ?></p>
                ...
                <?php else: ?>
                    <div class="mensaje-sin-mascotas">
                        ...
                        <button class="btn-add" onclick="window.location.href='mis-mascotas.php'">
