...
<body>
    ...
    <?php if (!empty($reporte['foto_usuario']) && $reporte['foto_usuario'] !== 'usuario-default.jpg'): ?>
        <img src="<?php echo htmlspecialchars($reporte['foto_usuario']); ?>" 
             alt="Foto de <?php echo htmlspecialchars($reporte['nombre_usuario']); ?>"
