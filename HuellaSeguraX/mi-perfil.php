...
<<<<<<< Updated upstream
                <div class="avatar-container">
                    ...
                    <input type="file" id="inputFotoPerfil" accept="image/jpeg,image/jpg,image/png,image/webp" style="display: none;"
                        onchange="subirFotoPerfil(this)">
                </div>
                    ...
                    <?php if ($es_veterinario): ?>
                        <span class="badge-usuario badge-veterinario">
                            <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#DF9D9B">
                                <path
                                    d="M236-118 117-236q-22-20.93-22-50.97Q95-317 117-338l506-504q20.67-21 50.34-21Q703-863 724-842l119 118q21 20.93 21 50.97Q864-643 843-622L337-118q-20.67 21-50.34 21Q257-97 236-118Z" />
                            </svg>
